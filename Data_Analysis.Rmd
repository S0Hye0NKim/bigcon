...
```{r}
Age_lev <- c("00", "05", "10", "15", "20", "25", "30", "35", "40", "45", "50", "55", "60", "65", "70")
...
step <- MASS::stepAIC(glm_SK_Age_Binom)
...
SK_Time_HDONG_Modified <- SK_Time %>% 
  ...
  left_join(Wth_Day_HDONG, by = c("STD_YMD" = "Day", "HDONG_CD")) %>%
  mutate(Holiday = ifelse(Week_Day %in% c("토", "일"), 1, 0))
